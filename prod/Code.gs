...
// Run this once to set up the time trigger (every 5 minutes)
function installTrigger() {
  ...
  // Create a new trigger — runs every 5 minutes
  ScriptApp.newTrigger('syncNewFiles')
    .timeBased()
    .everyMinutes(5)
    .create();
  
  console.log('Trigger installed. syncNewFiles will run every 5 minutes.');
}
